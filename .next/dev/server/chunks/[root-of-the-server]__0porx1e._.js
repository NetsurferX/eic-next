...
async function POST(req) {
    try {
        ...
        const outFile = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["tmpdir"])(), `eic_${Date.now()}.wav`);
        // espeak-ng: British English, slightly slower rate
        await execAsync(`espeak-ng -v en-gb -s 130 -w "${outFile}" "${safe}"`, {
            timeout: 3000
        });
        const audio = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["readFile"])(outFile);
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["unlink"])(outFile).catch(()=>{});
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](audio, {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0porx1e._.js.map