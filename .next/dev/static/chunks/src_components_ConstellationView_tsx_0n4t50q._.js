        ...
        "ConstellationView.useMemo[nodes]": ()=>{
            ...
            for (const tok of tokens){
                ...
                for (const n of tok.nodes){
                    if (n.c !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$renderNode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLOR_SILENT"] && n.c !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$renderNode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLOR_CONSONANT"] && n.t.length > 0) colorCounts.set(n.c, (colorCounts.get(n.c) ?? 0) + 1);
                }
                const dominant = [
                    ...colorCounts.entries()
                ].sort({
...
//# sourceMappingURL=src_components_ConstellationView_tsx_0n4t50q._.js.map